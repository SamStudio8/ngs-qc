...
\subsection{Task and Time Management} Shortly before embarking on this
dissertation project, I had written my own todo list web application;
\textbf{Triage}.

\subsection{Time Considerations}
It must be remembered that this is supposed to be a minor project completed
alongside the study of other modules that have their own assignments...
