...
Table~\ref{tab:be-pset-cv}... impressive cross validation results...
...especially for the \textbf{WARNPASS} set...
...
tree is more complex and sprawling than Figure~\ref{fig:all-all-1}... ...perhaps
there are some parameters we could ideally add back in to the set...
...
However a drastic change has appeared in Figures~\ref{fig:top9-ignwarn-1}
and~\ref{fig:top9-ignwarn-2}! The graphs are far more simple and linear...
...the wide sprawls have been traded in for relatively uniform decisions...
...it would appear that ignoring warnings removes a lot of noisy data that
becomes overfit... learning particular circumstances for rare events...
