...
Once inserted, samples are amplified in situ, in the flowcell itself. A
...
clusters (in reality there would actually be millions) of Sample A combine to
...
sequence data files %BAM and produces key-value summary numbers as well as more
...
It may be worth nothing that although the plot does not make a particular
