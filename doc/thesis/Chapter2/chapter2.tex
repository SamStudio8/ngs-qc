...
\subsubsection{"BAMcheckeR'd" Data}
...
...the one-to-one mapping between each input file and the result of its
classification by the current auto\_qc system...
A truncated example of such file can be found in Appendix~\ref{app:aqc_matrix}.
...the true files carry many various columns that cannot be detailed for
confidentiality (and indeed brevity)....
