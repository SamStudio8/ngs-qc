...
membership of an ID in \textbf{\_data} and \textbf{\_targets} which is constant
for a dictionary and $O$(n) for a list structure.
...
It should be noted that the \textbf{Statplexer} stores a copy of the
user defined CLASSES dictionary, which is an argument to its construction,
allowing the \textbf{Statplexer} to share this information with any readers or
utility functions who require it.
