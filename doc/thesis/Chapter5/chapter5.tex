...
during the assembly of the analysis pipeline. Ultimately we ran out of time
before being able to put the pipeline to use. The difficulties experienced with
\textbf{samtools merge} specifically are detailed in Appendix~\ref{app:test-leaks}.
