...
input files that contain chromosome and base position entries...
...
...
...
\textbf{Goldilocks} requires the user provide their own valid "paths file",
...
\textbf{load\_variant\_files} is a simple function to read the paths file and
