...
on a \textit{stride}. A \textbf{candidate} region will contain some count of
variants for each group. In the context of this project we consider the number
of variant locations that fall within this region for both the \textbf{GWAS} and
\textbf{iCHIP} data sets.
