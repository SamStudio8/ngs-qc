...
and thus the concordance script. Considering this and for the sake of brevity,
discussion on the design and implementation is considered outside the scope of
this write-up.

\textbf{SnpSift Concordance}\citep{snpeff-concordance}
